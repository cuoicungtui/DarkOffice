...
Communicate with DarkOffice via WhatsApp using a Baileys-based Node.js bridge.
...
Be careful: if you use your personal number and leave `allowed_numbers` open, other people could misuse your DarkOffice.
