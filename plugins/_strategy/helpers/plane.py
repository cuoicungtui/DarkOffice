...
class PlaneGateway(Protocol):
    ...
    def create_cycle(self, project_id: str, values: dict[str, Any]) -> dict[str, Any]: ...
    def create_module(self, project_id: str, values: dict[str, Any]) -> dict[str, Any]: ...
...
class HttpPlaneGateway:
    ...
    def create_cycle(self, project_id: str, values: dict[str, Any]) -> dict[str, Any]:
        return self._request("POST", f"/workspaces/{self.workspace_slug}/projects/{project_id}/cycles/", values)

    def create_module(self, project_id: str, values: dict[str, Any]) -> dict[str, Any]:
        return self._request("POST", f"/workspaces/{self.workspace_slug}/projects/{project_id}/modules/", values)
