...
function mount() {
  ...
  const refreshCreateForm = () => {
    ...
    formHint.textContent = needsProject ? "Chọn dự án Plane. Tiến độ dự án là tiến độ của mục tiêu." : northStarExists ? "Hệ thống chỉ có một Sao Bắc Cực." : "Loại này không tự tạo công việc Plane.";
  };
  const draw = () => {
