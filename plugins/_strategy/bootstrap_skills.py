...
SKILL_NAME = "darkoffice-strategy-execution"
...
def install(target_root: str | Path | None = None, *, force: bool = False) -> Path:
    ...
    marker.write_text(json.dumps({"skill": SKILL_NAME, "version": "1.0.0", "files": source_files}, indent=2) + "\n", encoding="utf-8")
    return target


def main() -> None:
    parser = argparse.ArgumentParser(description="Install the DarkOffice Strategy execution skill")
