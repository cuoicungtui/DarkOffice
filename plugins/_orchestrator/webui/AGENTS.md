...
- Use the DarkOffice plugin settings modal pattern: local `config`, `$store.pluginSettingsPrototype`, and a gated Alpine store.
...
- Refresh is a compact icon action consistent with DarkOffice settings UI.
