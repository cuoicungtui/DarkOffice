...
Communicate with DarkOffice through email inboxes and send replies back over SMTP.
...
- **Thread routing**
  ...
  - Email replies inside an existing DarkOffice thread can use `/project`, `/config`, and `/send` control commands.
...
- **Description**: Communicate with DarkOffice via email. Supports IMAP/Exchange inbox polling with SMTP replies.
