...
Built-in DarkOffice plugin for pinning chats and scheduled tasks to the top of their sidebar lists.
...
- Persists state in DarkOffice's user key-value storage.
