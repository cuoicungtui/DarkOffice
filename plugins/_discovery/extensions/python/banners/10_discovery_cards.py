...
class DiscoveryCardsExtension(Extension):
    ...
    async def execute(self, banners: list = [], frontend_context: dict = {}, **kwargs):
        ...
        banners.append({
            ...
            "description": "Extend DarkOffice with integrations, tools, and automations from the community.",
        ...
        if not email_is_configured:
            banners.append({
                ...
                "type": "feature",
                "title": "Email",
                "description": "Let DarkOffice read and send emails on your behalf.",
