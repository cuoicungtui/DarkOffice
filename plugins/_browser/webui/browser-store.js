...
const model = {
  ...
  createExtensionWithAgent() {
    this._prefillAgentPrompt(
      [
        "Use the browser-extension-control skill to create a new Chrome extension for DarkOffice's Browser.",
  ...
  askAgentInstallExtension() {
    ...
    const prompt = url
      ? [
          "Use the browser-extension-control skill to review and optionally install this Chrome Web Store extension for DarkOffice's Browser.",
          `Chrome Web Store URL or id: ${url}`,
          "Explain the permissions and any sandbox risk before enabling it.",
        ].join("\n")
      : [
          "Use the browser-extension-control skill to help me install and review a Chrome Web Store extension for DarkOffice's Browser.",
