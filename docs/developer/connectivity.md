...
| Need | Start here |
| --- | --- |
| Let DarkOffice work on your host files, shell, or browser | [A0 CLI Connector](../guides/a0-cli-connector.md) |
| Add a third-party tool through MCP | [MCP Setup](../guides/mcp-setup.md) |
| Let another agent talk to DarkOffice | [A2A Setup](../guides/a2a-setup.md) |
...
You can find your API token in DarkOffice under **Settings > External Services**.

Common external endpoints include:

| Endpoint | Use it for |
| --- | --- |
| `POST /api_message` | Send a message to DarkOffice. |
...
Use MCP when you want DarkOffice to call tools from another app or service.

Use A2A when you want another agent to talk to DarkOffice as a collaborator.

Both use the same DarkOffice instance and can be project-aware when configured
that way.
