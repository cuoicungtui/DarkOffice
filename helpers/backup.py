...
class BackupService:
    """
    Core backup and restore service for DarkOffice.
    ...
    def __init__(self):
        ...
        self.agent_zero_root = files.get_abs_path("")  # Resolved DarkOffice root
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes DarkOffice project directory patterns.
        """
...
"""
    ...
    def _get_agent_zero_version(self) -> str:
        """Get current DarkOffice version"""
        try:
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up DarkOffice root path with the current DarkOffice root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up DarkOffice root
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up DarkOffice root
