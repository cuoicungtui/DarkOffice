...
def print_troubleshooting():
    ...
    print("   - Make sure DarkOffice is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ DarkOffice server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to DarkOffice server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start DarkOffice server if not running")
